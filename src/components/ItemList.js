...
//             />
//             <button className="mt-2 text-green-600 font-bold border border-gray-300 px-3 py-1 rounded shadow-sm hover:shadow-md text-[12px] cursor-pointer" onClick={() => handleAddItem(item)}>
//             ADD
//             </button>
